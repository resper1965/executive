        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-2xl mx-auto">
          <Link href="/diagnostic" className="flex-1">
            <Button 
              size="lg" 
              variant="secondary" 
              className="w-full rounded-xl px-8 py-8 font-bold text-lg shadow-lg hover:shadow-xl transition-all"
              onClick={() => gtag.event({ action: "click_diagnostic", category: "conversion", label: "home_tools" })}
            >
          ...
          <Link href="/checklist/rn623" className="flex-1">
            <Button 
              ...
              variant="secondary" 
              className="w-full rounded-xl px-8 py-8 font-bold text-lg shadow-lg hover:shadow-xl transition-all"
              onClick={() => gtag.event({ action: "click_checklist", category: "conversion", label: "home_tools" })}
            >
